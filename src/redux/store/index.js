...
import customerApi from '@src/containers/app/feature/Customer/customerService.js'
...
export function configureAppStore(preloadedState) {
  let store = configureStore({
    ...
    middleware: (getDefaultMiddleware) =>
      ...
      }).concat(loggerMiddleware, authApi.middleware, adminApi.middleware, customerApi.middleware, rtkQueryToastify),
    preloadedState,
    enhancers: []
  })
